<template>
  <div class="homepage">
    ...
    <div class="live">
      <h1>乐享生活100+</h1>
      <div class="live-list">
        <div class="live-item" v-for="                   index                    in                    10                   "
      ...
      <a-button
        style="background: rgb(152, 110, 166);border: none;color:white;font-weight: 800;box-shadow: 10px 10px 10px rgba(0, 0, 0, 0.26)"
        shape="round" size="large" @click="router.push('/product')">立即享受生活</a-button>
    </div>
  </div>
</template>
